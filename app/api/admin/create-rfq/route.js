  ...
  try {
    ...
    const { data, error } = await supabaseAdmin
      ...
      .insert([{
        ...
        buyer_name: buyer?.buyer_name || 'Global Buyer',
        company_name: buyer?.company_name_en || 'Global Sourcing LLC',
        buyer_company_name: buyer?.company_name_en || 'Global Sourcing LLC',
