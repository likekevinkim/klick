...
export async function POST(request) {
  try {
    ...
    const {
      ...
      sellerAddress = '123, Industrial-ro, Namdong-gu, Incheon, Republic of Korea',
      sellerContact = '+82-32-123-4567 / export@hankookprecision.com',
      buyerCompany = 'Global Sourcing LLC',
      buyerAddress = '789 Trade Tower, Los Angeles, CA, USA',
      buyerContact = '+1-213-555-0199 / sourcing@globalsourcing.com',
